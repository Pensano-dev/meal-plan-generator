...
import { ChakraProvider, Container, Heading, Button, Box, Divider, Text, FormControl, FormLabel, RadioGroup, Stack, Radio, Checkbox, Flex, Input, Center } from '@chakra-ui/react'
// import { PiEgg } from 'react-icons/fa';
  ...
  return (
    <ChakraProvider>
      ...
      <Container maxW="container.md">
        ...
        <Text mb={4}>Other (please separate each food item with a comma ",")</Text>
        <Input type="text"></Input>
          ...
          <FormControl>
            ...
            <Text mb={4}>Any food that you want to include
            (please separate each food item with a comma ",")</Text>
            <Input type="text"></Input>  
          </FormControl>
          <Center my={10}>
            <Button bg='#ffb301'  borderRadius='3xl'>CREATE YOUR MEAL PLAN</Button>
          </Center>
      </Container>     
    </ChakraProvider> 
  );
